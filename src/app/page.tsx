    ...
    <main className="w-full h-screen flex justify-center items-center" >
      <div className="h-[80%] w-[70%] flex flex-col items-center lg:flex-row">
        ...
        <div className="w-[100%] lg:mt-0 mt-[60px] lg:w-[50%] flex flex-col items-center lg:items-start text-center lg:text-left md:order-1">
          ...
          <Link className="p-2 w-[300px] text-center lg:mb-0  bg-[#08ff65] rounded-3xl mt-[10px] text-black hover:bg-[#08ff67d3]"
            href="/home"
          >
            Enter
          </Link>
          <Link className="p-2 w-[300px] text-center lg:mb-0 mb-[100px] bg-[#08ff65] rounded-3xl mt-[10px] text-black hover:bg-[#08ff67d3]"
            href="/preSale"
          >
            Presale
          </Link>
